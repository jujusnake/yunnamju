    ...
    <main className={`flex flex-col p-6 md:p-12 md:flex-row-reverse gap-11 md:gap-12`}>
      ...
      <section className="text-[13px] leading-[160%] md:text-[16px] md:leading-[150%] font-medium text-typo-main">
        <p className="mb-5 md:mb-6">
          Hello, I am Namju Yun. I am a junior <EasyUnderlineAnimate>web front-end developer</EasyUnderlineAnimate> with
          a passion for continuous skill enhancement and delivering top-tier web services.
        </p>
        <p className="mb-5 md:mb-6">
          As a reliable and responsible developer, I hold myself accountable for ensuring all tasks are done without
          bugs and <EasyUnderlineAnimate>never allow deadlines to pass</EasyUnderlineAnimate> without all tasks achieved
          completely.
        </p>
